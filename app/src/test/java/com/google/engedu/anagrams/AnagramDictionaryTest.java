...
public class AnagramDictionaryTest {
    ...
    public void getAnagramsWithOneMoreLetter2(){
        System.out.println(anagrams.getAnagramsWithOneMoreLetter("pot").toString());
        assertArrayEquals(
    ...
    public void testSortLetters() {
        ...
        assertEquals(AnagramDictionary.sortLetters("start"), "arstt");
    }
    ...
    public void testIsAnagram() {
        ...
        assertFalse(AnagramDictionary.isAnagram("post", "start"));
        //assertTrue(AnagramDictionary.isAnagram("post", "start"));
    }
